# MASK_RCNN_OD_Inception_v2_COCO
---

I have Used Mask_RCNN + InceptionV2 using the COCO dataset of Dog Images

I trained the Model over 2000 Steps and used the Freezed Inference Graph for doing prediction in Jupyter Notebook.
...
* Generate dog crops using Mask R-CNN 
* Finetuning on Image Net models - Inception V2
* Multi- stage Training
* Mask R-CNN and COCO Dateset Model combined end-to-end for testing purpose
...
@misc{matterport_maskrcnn_2017,
  ...
  howpublished={\url{https://github.com/iamsj2022/MASK_RCNN_OD_Inception_v2_COCO}},
}
```
